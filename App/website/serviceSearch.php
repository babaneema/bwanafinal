...
require_once './data/serviceProvider.php';
require_once './data/getFarmerData.php';

if (session_status() === PHP_SESSION_NONE) session_start();
if (isset($_SESSION['serviceSearch'])) {
    $productData = $_SESSION['serviceSearch'];
    // var_dump($productData);
    unset($_SESSION['serviceSearch']);
} else {
                                            ...
                                            <div id="grid" class="related tab-pane fade in active show">
                                                <div class="row">
                                                    ...
                                                    foreach ($productData as $data) {
                                                        $picha = explode(',', $data['prod_images']);
                                                        $image = '../' . $picha[0];
                                                    ?>
                                                        <div class="item text-center col-md-4">
                                                            <div class="product-miniature js-product-miniature item-one first-item">
                                                                <div class="thumbnail-container border">
                                                                    <a href="viewServiceProvide.php?pass_id=<?= $data['pro_unique'] ?>">
