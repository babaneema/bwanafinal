            ...
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li>
                            <a href="addAgronomist.php">Add</a>
                        </li>

                        <li>
                            <a href="viewAgronomists.php">View</a>
                        </li>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li>
                            <a href="serviceprovider.php">View</a>
                        </li>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li>
                            <a href="addLearing.php">Add</a>
                        </li>

                        <li>
                            <a href="learn.php">View</a>
                        </li>
